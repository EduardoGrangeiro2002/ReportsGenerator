defmodule ReportsGeneratorTest do
  ...
  describe "build_from_many/1" do
    ...
    test "when file is not provided, return an error" do
  ...
  describe "fetch_higher_cost/2" do
    ...
    test "when invalid options, returns an error" do
      file_name = "report_test.csv"

      response =
        file_name
        |> ReportsGenerator.build()
        |> ReportsGenerator.fetch_higher_cost("test")
